...
if __name__ == "__main__":
    ...
    # File handling
    import os
    file_path = os.path.join('LSTM_Model', 'event_based_segmentation', 'M_and_D_sensors_labeled_AllSensors.json')

    # Define the directory for saving models and dependencies
    save_dir = os.path.join('LSTM_Model', 'event_based_segmentation', 'scaler_and_dependencies')
